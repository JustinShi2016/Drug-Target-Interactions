function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]...
    =MLKNN_testWithKernel(train_target,test_similarity,test_target,Num,Prior,PriorN,Cond,CondN, NoAssessment)
...
if NoAssessment % Add by JYSHI 2015-01-24
    Pre_Labels=[];
    HammingLoss=[];
    RankingLoss=[];
    OneError=[];
